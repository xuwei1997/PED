...
from con_resnet import self_sup_resnet
...
if __name__ == '__main__':
    ...
    # 导入未完成！
    # siamese.load_weights("/home/dell/python/Cherry_unsup/self_supervised_resnet/self_logs/h5_2022_03_28_21_14_26_4w分区增强/ep006-loss0.515-val_loss0.510.h5",by_name=True,skip_mismatch=True)

    siamese.compile(loss=loss(T), optimizer="RMSprop", metrics=["mse"])
